            ...
            <table>
                ...
                <%
                    try {
                        ...
                        PreparedStatement ps = con.prepareStatement("select * from service_man");
                    ...
                    %>
                        <tr>
                            ...
                            <td><a href="deleteSman.jsp?id=<%=rs.getInt(1)%>" class="delete-button"><i class="fas fa-trash-alt"></i>Delete</a></td>
                        </tr>
                    <%
                        }
                    } catch (Exception e) {
